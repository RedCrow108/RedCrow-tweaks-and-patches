...
namespace RedCrow.InsectorTweaks
{
    ...
    public static class PherocoreBalanceIntegration
    {
        ...
        private static readonly BalanceEntry[] BalanceEntries =
        {
            ...
            new BalanceEntry("RC_Evolution_PheromoneUnity", false, 2, 2),
            new BalanceEntry("RC_Evolution_MatriarchWail", false, 3, 2),
            new BalanceEntry("RC_Evolution_PsiMimicry", false, 4, 3),
            new BalanceEntry("RC_Evolution_InsanityPulse", false, 4, 4),
            new BalanceEntry("RC_Evolution_UnconstrainedCarapace", false, 2, 2),
            new BalanceEntry("RC_Evolution_MatriarchCalmAura", false, 4, 5),
            new BalanceEntry("RC_Evolution_CoagulatingSecretion", false, 4, 3),
            new BalanceEntry("RC_Mutation_LightStride", true, 3, 3),
            new BalanceEntry("RC_Mutation_TwilightStride", true, 3, 3),
            new BalanceEntry("RC_Mutation_HiveElectroOrgan", true, 3, 3),
            new BalanceEntry("RC_Mutation_ThreatMark", true, 3, 3),
            new BalanceEntry("RC_Mutation_DoomOmen", true, 5, 5),
            new BalanceEntry("RC_Mutation_SolarOverdrive", true, 4, 3),
            new BalanceEntry("RC_Mutation_SolarStupor", true, 4, 4),
